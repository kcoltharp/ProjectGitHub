...
class Process
{
   ...
   function procEditAccount(){
      ...
      $retval = $session->editAccount($_POST['curpass'], $_POST['newpass'], $_POST['email'],$_POST['dailyreminders'],$_POST['language'],$_POST['includetodo'],$_POST['includedeadlines'],$_POST['timezone']);
