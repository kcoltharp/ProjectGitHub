...
function dup_item($item){
	...
	$sql = mysql_query("SELECT * FROM database WHERE name = '$name'");
	$count = mysql_num_rows($sql);
	if($count >= 1){
		echo'<h2>This item has already been added to the list!</h2>';
		//echo '<META http-equiv="refresh" content="1;URL=http://kennys-spot.org/index.php">';
		echo '<META http-equiv="refresh" content="4;URL=http://kennys-spot.org/grocery.php">';
	}
}
?>